...
const HowItWorks = () => {
  ...
  const stepsData = [
    {
      number: "01",
      title: "Spin Up Your Space",
      description: "Log in, create or join a coding room. Set the vibe: public or private, pick roles, and you’re in.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "02",
      title: "Code Together, Seamlessly",
      description: "Collaborate in real time with syntax highlighting, autocompletion, and live code execution. Assign roles like Editor, Viewer, or Moderator for secure and efficient teamwork.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "03",
      title: "Run, Review, Repeat",
      description: "Execute code in 5 major languages with instant output. Review logic, give feedback, and iterate smoothly — all without leaving the shared editor.",
    ...
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          <h2 className="section-title mb-4">How Livelet Fits Into Your Workflow</h2>
          <p className="section-subtitle mx-auto">
            No setup stress — just seamless real-time coding.
          </p>
        </div>
